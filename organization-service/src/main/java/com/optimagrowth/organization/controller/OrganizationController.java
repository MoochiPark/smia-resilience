...
public class OrganizationController {
    ...
    private OrganizationController(final OrganizationService service) {
    ...
    public void update(@PathVariable("organizationId") String organizationId, @RequestBody Organization organization) {
